...
`fig_output/` folder for the figures that we will save. For this course the necessary folders have been created already, but if you want to add new folders yourself you can do the following:
